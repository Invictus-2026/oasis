...
frontend/src/
  ...
  App.tsx            React Router routes, one page per pipeline stage
  context/           SpillContext — centralised case/detection/drift/attribution state
  pages/             Overview, MaritimeMap, SatelliteIntelligence, DriftIntelligence,
                     Attribution, Reports (unfinished routes render Placeholder)
  components/        MapView, layout/ (Sidebar, Topbar, AppLayout) + shared panels
