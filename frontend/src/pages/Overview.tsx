  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total Incidents", value: "12", color: "text-blue-600 dark:text-blue-400" },
          { label: "Active Incidents", value: "7", color: "text-blue-600 dark:text-blue-400" },
          { label: "Under Investigation", value: "4", color: "text-slick-500" },
          { label: "Critical Alerts", value: "3", color: "text-alert-500" },
        ].map((stat, i) => (
          <div key={i} className="bg-white dark:bg-ink-100 p-6 rounded-lg border border-ink-200 shadow-sm flex flex-col">
